# -*- coding: utf-8 -*-
"""
Created on Tue Sep 29 12:37:19 2020
...
choosen_x = int(input('Choose the number (between 1 and 222) of the x-variable (for example 1 for UTC): '))
choosen_y = int(input('Choose the number (between 1 and 222) of the y-variable (for example 8 for TEMP): '))
...
if Plot_chosen == '1':
    ...
    ax.set_extent([120, 180, -38, -72], ccrs.PlateCarree())
    ax.set_title('RVI', pad=30)
    ...
    # ax1.axis('off')
        ...
        ax.set_title('1oth January 2018/February 2018 (v1)', fontsize=30, pad=30)
    #ax.stock_img()
        ax.gridlines()
